-- =========================================================
-- EduVerse LMS - Production Migration & Security Fix
-- File: supabase/08_secure_classes_and_enrollments_migration.sql
-- AMAN & NON-DESTRUCTIVE (ALTER TABLE ... ADD COLUMN IF NOT EXISTS)
-- =========================================================

-- 1. Tambah Kolom yang Diperlukan pada Tabel public.classes (Jika Belum Ada)
...
-- 2. Tambah Kolom yang Diperlukan pada Tabel public.enrollments (Jika Belum Ada)
...
-- 3. Aktifkan Row Level Security (RLS) pada Tabel classes & enrollments
ALTER TABLE public.classes ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.enrollments ENABLE ROW LEVEL SECURITY;

-- 4. Bersihkan Kebijakan Lama jika ada
...
-- 5. Kebijakan RLS Ketat Khusus Peran 'authenticated' (Pengguna yang Sudah Login)
...
-- 6. Hak Akses (GRANT): Hanya Berikan ke Peran authenticated & service_role (TIDAK ADA GRANT KE ANON)
